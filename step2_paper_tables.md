...
(Missing: could not parse predicted pct from step2_final_models.md)
...
| outcome | test | stat | df | p |
| --- | --- | --- | --- | --- |
| any_delay | chi2 | 1.667 | 2 | 0.434 |
| log1p_delay | F | 3.278 | (2, 141) | 0.041 |
| late90 | chi2 | 0.685 | 2 | 0.710 |
